...
set(ARROW_DEPS_INSTALL_DIR "${VELOX_HOME}/deps-install")
set(ARROW_LIB_DIR "${ARROW_INSTALL_DIR}/lib")
set(ARROW_LIB64_DIR "${ARROW_INSTALL_DIR}/lib64")
set(ARROW_DEPS_LIB_DIR "${ARROW_DEPS_INSTALL_DIR}/lib")
set(ARROW_DEPS_LIB64_DIR "${ARROW_DEPS_INSTALL_DIR}/lib64")
...
function(FIND_ARROW_LIB LIB_NAME)
  if(NOT TARGET Arrow::${LIB_NAME})
    ...
    find_library(
      ...
      PATHS ${ARROW_DEPS_LIB_DIR} ${ARROW_DEPS_LIB64_DIR} ${ARROW_LIB_DIR}
            ${ARROW_LIB64_DIR}
      NO_DEFAULT_PATH)
