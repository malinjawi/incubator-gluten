...
TEST(RoaringBitmapArrayTest, DeserializesDeltaJvmPortablePayloadWithSparseGap) {
  ...
  const std::vector<uint8_t> deltaJvmBytes{
      0xd1, 0xd3, 0x39, 0x64, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3a, 0x30, 0x00, 0x00,
      0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x10, 0x00,
      0x00, 0x00, 0x01, 0x00, 0x07, 0x00, 0x01, 0x00, 0x00, 0x00,
      0x3a, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00,
      0x00, 0x00, 0x3a, 0x30, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
...
TEST(RoaringBitmapArrayTest, SerializesSparseGapAsCompactPortablePayload) {
  ...
  const std::vector<uint8_t> expectedBytes{
      0xd1, 0xd3, 0x39, 0x64, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3a, 0x30, 0x00, 0x00,
      0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x10, 0x00,
      0x00, 0x00, 0x01, 0x00, 0x07, 0x00, 0x02, 0x00, 0x00, 0x00,
      0x3a, 0x30, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
...
TEST(RoaringBitmapArrayTest, EnforcesDeltaRowIndexBounds) {
  ...
  VELOX_ASSERT_THROW(
      bitmap.addSafe(RoaringBitmapArray::kMaxRepresentableValue + 1),
...
TEST(RoaringBitmapArrayTest, RejectsPayloadAboveDeltaMaxRowIndex) {
  ...
  std::vector<char> payload(
      sizeof(uint32_t) + sizeof(uint64_t) + sizeof(uint32_t) + highBitmap.getSizeInBytes(true));
...
TEST(RoaringBitmapArrayTest, RejectsBadMagic) {
  ...
  VELOX_ASSERT_THROW(
      bitmap.deserialize(invalid.data(), invalid.size()),
